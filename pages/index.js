          ...
          <Container>
            ...
            >
              ...
              <Skeleton isLoaded={!address ? true : userTokenBalance}>
                <HeaderStat
                  label="Your $ROSES balance"
                  value={userTokenBalance ? userTokenBalance : 0}
                />
              </Skeleton>
              <Skeleton isLoaded={!address ? true : userTokenBalance}>
                <HeaderStat
                  label="$ROSES reward pool"
        ...
        >
          <SimpleGrid columns={{ base: 1, md: 2 }} gap={{ base: 5, md: 6 }}>
            ...
            >
              ...
              <Heading size="md">Get Garden NFT</Heading>
              <Stack spacing="6">
                <li>You can get as much NFTs as you need.</li>
                <li>Garden NFTs follow the ERC1155 Standard.</li>
                <li>
            ...
            <Box>
              ...
              <Text color="muted" mt="5">
                Here you can stake your Garden NFTs, unstake them, and claim
                your rewards in $ROSES tokens.
              </Text>
              <Divider my="5" />
              <Stack
                spacing="8"
              ...
              >
                <Stat>
                  <StatLabel>Your pending $ROSES token rewards</StatLabel>
